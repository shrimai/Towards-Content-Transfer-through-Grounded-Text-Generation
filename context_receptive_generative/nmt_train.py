...
parser.add_argument('-add_context', type=int, default=1,
                    help="""Add context of the paragraph.""")
...
def eval(model, criterion, data):
    ...
    for i in range(len(data)):
        ...
        outputs = model(batch)
        targets = batch[2][1:]  # exclude <s> from targets
...
def trainModel(model, trainData, validData, dataset, optim):
    ...
    for epoch in range(opt.start_epoch, opt.epochs + 1):
        ...
        checkpoint = {
            ...
            'encoder_cxt': model.encoder_src.state_dict(),
